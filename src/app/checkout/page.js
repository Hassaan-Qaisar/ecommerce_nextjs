...
export default function Checkout() {
    ...
    async function createFinalOrder() {
      ...
      if (
        ...
        if (res.success) {
          ...
          const shippingAddress = createFinalCheckoutFormData.shippingAddress;
          const { fullName, city, country, address } = shippingAddress;

          const customerEmail = user?.email;
          const customerName = user?.name;
          const orderDetails = `Customer: ${user?.name} \n Email: ${user?.email} \n Order: ${createFinalCheckoutFormData.orderItems[0].product.name} \n Quantity: ${createFinalCheckoutFormData.orderItems[0].qty} \n Total Price: ${createFinalCheckoutFormData.totalPrice} \n Payment Method: ${createFinalCheckoutFormData.paymentMethod} \n Address: ${address} ${city}`;
  ...
  async function handleCOD() {
    ...
    if (res.success) {
      ...
      const customerEmail = user?.email;
      const customerName = user?.name;
      const orderDetails = `Order ID: ${orderID2} \n Customer: ${customerName} \n Email: ${customerEmail} \n Order: ${createFinalCheckoutFormData.orderItems[0].product.name} \n Quantity: ${createFinalCheckoutFormData.orderItems[0].qty} \n Total Price: ${createFinalCheckoutFormData.totalPrice} \n Payment Method: ${createFinalCheckoutFormData.paymentMethod} \n Address: ${address} ${city}`;
            ...
            <div className="bg-white shadow">
              <div className="px-4 py-6 sm:px-8 sm:py-10 flex flex-col gap-5">
                <h1 className="font-bold text-lg">
                  Your order has been placed and you will be redirected to
